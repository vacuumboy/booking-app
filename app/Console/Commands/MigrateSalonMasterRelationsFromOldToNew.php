...
class MigrateSalonMasterRelationsFromOldToNew extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:migrate-salon-master-relations-from-old-to-new';
     ...
     * @var string
     */
    protected $description = 'Мигрирует связи мастеров и салонов из старой структуры (salon_id) в новую (таблица salon_master)';
    ...
    {
        $this->info('Начинаем миграцию связей мастеров и салонов из старой структуры в новую...');
