                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('clients.update', $client) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="phone" class="block mt-1 w-full" type="tel" name="phone" :value="old('phone', $client->phone)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="language" name="language" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                ...
                                <option value="ru" {{ old('language', $client->language) == 'ru' ? 'selected' : '' }}>Русский</option>
                                <option value="lv" {{ old('language', $client->language) == 'lv' ? 'selected' : '' }}>Латышский</option>
                        ...
                        <div class="mb-6 mx-4">
                            ...
                            <textarea id="notes" name="notes" rows="4" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('notes', $client->notes) }}</textarea>
