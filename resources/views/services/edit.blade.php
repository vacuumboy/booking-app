                    ...
                    <form method="POST" action="{{ route('services.update', $service) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <x-text-input id="name_ru" class="block mt-1 w-full" type="text" name="name_ru" :value="old('name_ru', $service->name_ru)" />
                            ...
                            <div class="mb-3">
                                ...
                                <x-text-input id="name_lv" class="block mt-1 w-full" type="text" name="name_lv" :value="old('name_lv', $service->name_lv)" />
                            ...
                            <div class="mb-3">
                                ...
                                <x-text-input id="name_en" class="block mt-1 w-full" type="text" name="name_en" :value="old('name_en', $service->name_en)" />
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex">
                                <x-text-input id="price" class="block mt-1 w-full rounded-r-none" type="number" name="price" min="0" step="0.01" :value="old('price', $service->price)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex">
                                <x-text-input id="duration" class="block mt-1 w-full rounded-r-none" type="number" name="duration" min="5" max="480" :value="old('duration', $service->duration)" required />
                                <span class="inline-flex items-center px-3 mt-1 text-sm text-gray-900 bg-gray-200 border border-l-0 border-gray-300 rounded-r-md">
                                    мин.
                                </span>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center">
                                <input type="color" id="color" name="color" value="{{ old('color', $service->color ?? '#3B82F6') }}" class="block mt-1 w-16 h-10 border border-gray-300 rounded-md cursor-pointer">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="4" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description', $service->description) }}</textarea>
